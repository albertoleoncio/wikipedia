...
if ($_GET["conta"]) {
	...
	*/
	...
	if ($result['-1']) {
		//Criar página raiz
		echo "<li class=\"w3-padding-small w3-left-align\" style=\"cursor:pointer;\" onclick=\"window.open('https://pt.wikipedia.org/w/index.php?action=edit&preload=Template%3ADB1%2FPreload&title=Wikipedia%3APedidos+a+administradores%2FDiscuss%C3%A3o+de+bloqueio%2F".urlencode($conta)."&preloadparams%5B%5D=".urlencode($evidence)."&preloadparams%5B%5D=%7B%7B%23if%3A".urlencode($defesa)."%7C%7B%7Bcita%C3%A7%C3%A3o2%7C1%3D".urlencode($defesa)."%7C2%3D%7B%7Bdif%7C".urlencode($diff)."%7D%7D%7D%7D%7D%7D', '_blank')\">Criar DB</li>\n";
		...
		echo "<li class=\"w3-padding-small w3-left-align\" style=\"cursor:pointer;\" onclick=\"window.open('https://pt.wikipedia.org/w/index.php?title=Predefini%C3%A7%C3%A3o:MRConduta&action=edit', '_blank')\">Publicar DB no painel</li>";
		if ($sysop) {
		...
		if (!$desambig) {
			...
			echo "<li class=\"w3-padding-small w3-left-align\" style=\"cursor:pointer;\" onclick=\"window.open('https://pt.wikipedia.org/w/index.php?action=edit&preload=Template%3ADB1%2FPreload&title=Wikipedia%3APedidos+a+administradores%2FDiscuss%C3%A3o+de+bloqueio%2F".urlencode($conta)."%2F2&preloadparams%5B%5D=".urlencode($evidence)."&preloadparams%5B%5D=%7B%7B%23if%3A".urlencode($defesa)."%7C%7B%7Bcita%C3%A7%C3%A3o2%7C1%3D".urlencode($defesa)."%7C2%3D%7B%7Bdif%7C".urlencode($diff)."%7D%7D%7D%7D%7D%7D', '_blank')\">Criar DB/2</li>\n";
			...
			//Criar página /$count
			echo "<li class=\"w3-padding-small w3-left-align\" style=\"cursor:pointer;\" onclick=\"window.open('https://pt.wikipedia.org/w/index.php?action=edit&preload=Template%3ADB1%2FPreload&title=Wikipedia%3APedidos+a+administradores%2FDiscuss%C3%A3o+de+bloqueio%2F".urlencode($conta)."%2F".$count."&preloadparams%5B%5D=".urlencode($evidence)."&preloadparams%5B%5D=%7B%7B%23if%3A".urlencode($defesa)."%7C%7B%7Bcita%C3%A7%C3%A3o2%7C1%3D".urlencode($defesa)."%7C2%3D%7B%7Bdif%7C".urlencode($diff)."%7D%7D%7D%7D%7D%7D', '_blank')\">Criar DB</li>\n";
