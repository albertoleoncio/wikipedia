...
$stmt = mysqli_prepare($con, "INSERT IGNORE INTO `list_wp` (`cidade`, `qnde`) VALUES (?, ?)");
mysqli_stmt_bind_param($stmt, "si", $key, $value);
...
//Caso não existam mais cidades na lista, recupera dados dos artigos e procede para a atualização da página via bot
	...
	//Define página
	$page = 'Wikipédia:Wiki Loves Bahia/Queries/Artigos dos municípios';
